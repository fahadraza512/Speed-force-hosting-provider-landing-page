...
const features = ["10 GB SSD Storage", "Free SSL Certificate", "1 Website", "Daily Backups", "24/7 Support"];
    ...
    <div className="min-h-screen bg-neutral-950 flex">
        ...
        <div className="relative z-10">
          ...
          <div className="bg-white/4 border border-white/8 rounded-2xl p-6 mb-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h3 className="text-white font-black text-lg tracking-tight">Starter Plan</h3>
                <p className="text-neutral-500 text-xs mt-0.5">Cloud Hosting</p>
              </div>
              <div className="text-right">
                <p className="text-white font-black text-2xl tracking-tighter">$3.99</p>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between text-neutral-500"><span>Subtotal</span><span>$3.99</span></div>
            <div className="flex justify-between text-neutral-500"><span>Tax</span><span>$0.00</span></div>
            <div className="h-px bg-white/6 my-2" />
            <div className="flex justify-between text-white font-black text-base"><span>Total today</span><span>$3.99</span></div>
            <p className="text-neutral-600 text-xs pt-1">Then $3.99/month. Cancel anytime.</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-[420px]">
          <div className="mb-8">
            <h1 className="text-2xl font-black text-white tracking-tight mb-1.5">Start your free trial</h1>
